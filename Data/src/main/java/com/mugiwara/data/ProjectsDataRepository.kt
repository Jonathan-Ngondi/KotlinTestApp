package com.mugiwara.data

import com.mugiwara.data.mapper.ProjectMapper
import com.mugiwara.data.repository.ProjectsCache
import com.mugiwara.data.store.ProjectsDataStoreFactory
...
class ProjectsDataRepository @Inject constructor(
  ...
  override fun getProjects(): Observable<List<Project>> {
    return Observable.zip(cache.areProjectsCached().toObservable(),
        ...
        BiFunction<Boolean, Boolean, Pair<Boolean, Boolean>>{areCached, isCacheExpired ->
          Pair(areCached, isCacheExpired)
        })
        .flatMap {
